...
kernels_list = {
    ...
    18:  kernelInstance(256,     1,   128,   128,    64,    64,   256,  16,  16,  32,   32,    1,    1,     [16, 16, 1],     [16, 16, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),    # Larger M tile (Oct 31)
    19:  kernelInstance(256,     1,   128,   128,   256,   128,   128,  16,  16,  32,   32,    4,    2,     [ 8, 32, 1],     [ 8, 32, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),
    20:  kernelInstance(384,     1,   128,   128,   192,   128,   128,  16,  16,  32,   32,    3,    2,     [ 8, 32, 1],     [ 8, 32, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),
    21:  kernelInstance(1024,    1,   128,   128,   256,   256,   128,  16,  16,  32,   32,    4,    4,     [ 8, 32, 1],     [ 8, 32, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),
    22:  kernelInstance(1024,    1,   128,   128,   512,   128,   128,  16,  16,  32,   32,    8,    2,     [ 8, 32, 1],     [ 8, 32, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),
    23:  kernelInstance(256,     1,   128,   128,   128,   128,   256,  16,  16,  32,   32,    2,    2,     [ 8, 32, 1],     [ 8, 32, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),  # Like K0 but v1
    24:  kernelInstance(256,     1,   128,   128,   64,   256,   256,  16,  16,  32,   32,    2,    2,     [16, 16, 1],     [16, 16, 1],           1,           1,                   [1, 32, 1,  8],             [8],     "Intrawave",                  1,),  # Larger K
}
